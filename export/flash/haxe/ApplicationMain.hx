...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BossRushJam2024", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("BossRushJam2024", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "BossRushJam2024";
		app.meta["name"] = "BossRushJam2024";
